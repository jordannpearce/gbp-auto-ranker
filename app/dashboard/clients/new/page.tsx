    ...
    <div className="flex min-h-full flex-1 flex-col bg-surface">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-8 sm:px-6">
        ...
        <p className="mt-2 text-sm leading-6 text-muted-foreground">
          This listing is assigned to {agency?.name || "your agency"} and to
          your user account so your team can white-label the campaign.
        </p>
        <div className="mt-8 rounded-2xl border border-border bg-white p-5 sm:p-8">
          <IntakeForm error={error} returnTo="/dashboard" />
        </div>
      </main>
    </div>
  );
