...
export const DEFAULT_TEMPLATES: EmailTemplate[] = [
  ...
  },
  {
    ...
    label: "New client for agency",
    subject: "New client for {{agency}}: {{business_name}}",
    heading: "A new client was assigned",
    body: "Hi {{user}},\n\n{{agency}} was just assigned a new business: {{business_name}}.\n\nAgency owner: {{agency_owner}}\nListing: {{business_name}}\n\nOpen the dashboard, review the Maps URL and keywords, and follow up with the owner.",
    ctaLabel: "Open client",
    variables: [
      "name",
      "email",
